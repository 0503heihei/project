...
<section class="wrap">
    ...
    <nav>
        <ul class="pagination">
            <li class="xinwenzixun1"><a href="" >上一页</a></li>
            <li class="xinwenzixun1"><a href="" >1</a></li>
            <li class="xinwenzixun2"><a href="" style="background-color: #cccccc;">2</a></li>
            <li class="xinwenzixun2"><a href="">下一页</a></li>
            <li><a href="#">转至第</a></li>
            <li><a href="" style="width: 35px;height: 34px;">2</a></li>
